<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Consulta.aspx.cs" Inherits="BCN.SITIO.Consulta" %>
...
<body>
    ...
    <form runat="server" id="Form1">
        ...
        <section style="width: 100%; margin: 60px auto; text-align: center;">
            ...
            <h3>Para consultar tu Pasaporte Digital escanea tu huella digital.</h3>
            <br>
            <br>
            ...
            <div class="col-lg-12 text-center">
                <asp:Button runat="server" CssClass="btn btn-bbv2" ID="BtnPdf" Text="Validar" OnClick="BtnPdf_Click" />
            </div>
        </section>
